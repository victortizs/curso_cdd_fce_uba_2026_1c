...
cat("Los nombres de sus elementos son: ",
    if (is.null(names(lista_sin_nombres))) "no tienen" else paste(names(lista_sin_nombres), collapse = ", "),
    ".", sep = "", "\n\n"
    )
...
cat("Los nombres de sus elementos son: ",
    if (is.null(names(lista_con_nombres))) "no tienen" else paste(names(lista_con_nombres), collapse = ", "),
    ".", sep = "", "\n\n"
    )
```
